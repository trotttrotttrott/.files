...
" Autocommands {
    " Ruby {
        " au BufRead,BufNewFile *.rb,*.erb,*.haml,*.sass,*.scss set shiftwidth=2
        " au BufRead,BufNewFile *.rb,*.erb,*.haml,*.sass,*.scss set softtabstop=2
        "
        " (rails.vim handles the forementioned)
        "
        "
    " }
    " Stuff {
